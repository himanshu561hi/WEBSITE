...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function Pp(i,e,t){return new cn({name:"SphericalGaussianBlur",defines:{SAMPLES:Rp,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:sa(),fragmentShader:`
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function Jo(){return new cn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:sa(),fragmentShader:`
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function Qo(){return new cn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sa(),fragmentShader:`
...
`)}const Bm={[Il]:"Linear",[Dl]:"Reinhard",[Pl]:"Cineon",[Ur]:"ACESFilmic",[Ul]:"AgX",[Fl]:"Neutral",[Ll]:"Custom"};function km(i,e){const t=Bm[e];return t===void 0?(Ie("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Gs=new G;function zm(){Xe.getLuminanceCoefficients(Gs);const i=Gs.x.toFixed(4),e=Gs.y.toFixed(4),t=Gs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,M0=[new G(1,0,0),new G(-1,0,0),new G(0,1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1)],b0=[new G(0,-1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1),new G(0,-1,0),new G(0,-1,0)],gl=new ft,Wi=new G,Va=new G;function y0(i,e,t){let n=new Yr;const s=new je,a=new je,r=new ht,o=new Cu,l=new Nu,c={},h=t.maxTextureSize,p={[ti]:zt,[zt]:ti,[gn]:gn},u=new cn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new je},radius:{value:4}},vertexShader:v0,fragmentShader:S0}),m=u.clone();m.defines.HORIZONTAL_PASS=1;const v=new Gt;v.setAttribute("position",new ln(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const b=new ct(v,u),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Hs;let f=this.type;this.render=function(y,R,_){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||y.length===0)return;this.type===nd&&(Ie("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=Hs);const T=i.getRenderTarget(),C=i.getActiveCubeFace(),L=i.getActiveMipmapLevel(),F=i.state;F.setBlending(Nn),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const z=f!==this.type;z&&R.traverse(function(I){I.material&&(Array.isArray(I.material)?I.material.forEach(H=>H.needsUpdate=!0):I.material.needsUpdate=!0)});for(let I=0,H=y.length;I<H;I++){const j=y[I],Y=j.shadow;if(Y===void 0){Ie("WebGLShadowMap:",j,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;s.copy(Y.mapSize);const ie=Y.getFrameExtents();s.multiply(ie),a.copy(Y.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/ie.x),s.x=a.x*ie.x,Y.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/ie.y),s.y=a.y*ie.y,Y.mapSize.y=a.y));const W=i.state.buffers.depth.getReversed();if(Y.camera._reversedDepth=W,Y.map===null||z===!0){if(Y.map!==null&&(Y.map.depthTexture!==null&&(Y.map.depthTexture.dispose(),Y.map.depthTexture=null),Y.map.dispose()),this.type===Xi){if(j.isPointLight){Ie("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}Y.map=new on(s.x,s.y,{format:ii,type:Mn,minFilter:Pt,magFilter:Pt,generateMipmaps:!1}),Y.map.texture.name=j.name+".shadowMap",Y.map.depthTexture=new ss(s.x,s.y,xn),Y.map.depthTexture.name=j.name+".shadowMapDepth",Y.map.depthTexture.format=Dn,Y.map.depthTexture.compareFunction=null,Y.map.depthTexture.minFilter=At,Y.map.depthTexture.magFilter=At}else j.isPointLight?(Y.map=new rc(s.x),Y.map.depthTexture=new yu(s.x,Sn)):(Y.map=new on(s.x,s.y),Y.map.depthTexture=new ss(s.x,s.y,Sn)),Y.map.depthTexture.name=j.name+".shadowMap",Y.map.depthTexture.format=Dn,this.type===Hs?(Y.map.depthTexture.compareFunction=W?Vr:Hr,Y.map.depthTexture.minFilter=Pt,Y.map.depthTexture.magFilter=Pt):(Y.map.depthTexture.compareFunction=null,Y.map.depthTexture.minFilter=At,Y.map.depthTexture.magFilter=At);Y.camera.updateProjectionMatrix()}Y.map.isWebGLCubeRenderTarget!==!0&&(Y.map.width!==s.x||Y.map.height!==s.y)&&Y.map.setSize(s.x,s.y);const Z=Y.map.isWebGLCubeRenderTarget?6:Y.getViewportCount();j.isPointLight!==!0&&Y.updateMatrices(j,_);for(let ee=0;ee<Z;ee++){const be=Y.getCamera(ee);if(j.isPointLight){const Te=Y.camera,et=Y.matrix,Ge=j.distance||Te.far;Ge!==Te.far&&(Te.far=Ge,Te.updateProjectionMatrix()),Wi.setFromMatrixPosition(j.matrixWorld),Te.position.copy(Wi),Va.copy(Te.position),Va.add(M0[ee]),Te.up.copy(b0[ee]),Te.lookAt(Va),Te.updateMatrixWorld(),et.makeTranslation(-Wi.x,-Wi.y,-Wi.z),gl.multiplyMatrices(Te.projectionMatrix,Te.matrixWorldInverse),Y._frustum.setFromProjectionMatrix(gl,Te.coordinateSystem,Te.reversedDepth)}if(Y.map.isWebGLCubeRenderTarget)i.setRenderTarget(Y.map,ee),i.clear();else{ee===0&&(i.setRenderTarget(Y.map),i.clear());const Te=Y.getViewport(ee);r.set(a.x*Te.x,a.y*Te.y,a.x*Te.z,a.y*Te.w),F.viewport(r)}n=Y.getFrustum(ee),M(R,_,be,j,this.type)}Y.isPointLightShadow!==!0&&this.type===Xi&&w(Y,_),Y.needsUpdate=!1}f=this.type,x.needsUpdate=!1,i.setRenderTarget(T,C,L)};function w(y,R){const _=e.update(b);u.defines.VSM_SAMPLES!==y.blurSamples&&(u.defines.VSM_SAMPLES=y.blurSamples,m.defines.VSM_SAMPLES=y.blurSamples,u.needsUpdate=!0,m.needsUpdate=!0),y.mapPass===null?y.mapPass=new on(s.x,s.y,{format:ii,type:Mn}):(y.mapPass.width!==y.map.width||y.mapPass.height!==y.map.height)&&y.mapPass.setSize(y.map.width,y.map.height),u.uniforms.shadow_pass.value=y.map.depthTexture,u.uniforms.resolution.value.set(y.map.width,y.map.height),u.uniforms.radius.value=y.radius,i.setRenderTarget(y.mapPass),i.clear(),i.renderBufferDirect(R,null,_,u,b,null),m.uniforms.shadow_pass.value=y.mapPass.texture,m.uniforms.resolution.value.set(y.map.width,y.map.height),m.uniforms.radius.value=y.radius,i.setRenderTarget(y.map),i.clear(),i.renderBufferDirect(R,null,_,m,b,null)}function N(y,R,_,T){let C=null;const L=_.isPointLight===!0?y.customDistanceMaterial:y.customDepthMaterial;if(L!==void 0)C=L;else if(C=_.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const F=C.uuid,z=R.uuid;let I=c[F];I===void 0&&(I={},c[F]=I);let H=I[z];H===void 0&&(H=C.clone(),I[z]=H,R.addEventListener("dispose",E)),C=H}if(C.visible=R.visible,C.wireframe=R.wireframe,T===Xi?C.side=R.shadowSide!==null?R.shadowSide:R.side:C.side=R.shadowSide!==null?R.shadowSide:p[R.side],C.alphaMap=R.alphaMap,C.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,C.map=R.map,C.clipShadows=R.clipShadows,C.clippingPlanes=R.clippingPlanes,C.clipIntersection=R.clipIntersection,C.displacementMap=R.displacementMap,C.displacementScale=R.displacementScale,C.displacementBias=R.displacementBias,C.wireframeLinewidth=R.wireframeLinewidth,C.linewidth=R.linewidth,_.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const F=i.properties.get(C);F.light=_}return C}function M(y,R,_,T,C){if(y.visible===!1)return;if(y.layers.test(R.layers)&&(y.isMesh||y.isLine||y.isPoints)&&(y.castShadow||y.receiveShadow&&C===Xi)&&(!y.frustumCulled||y.intersectsFrustum(n))){y.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,y.matrixWorld);const z=e.update(y),I=y.material;if(Array.isArray(I)){const H=z.groups;for(let j=0,Y=H.length;j<Y;j++){const ie=H[j],W=I[ie.materialIndex];if(W&&W.visible){const Z=N(y,W,T,C);y.onBeforeShadow(i,y,R,_,z,Z,ie),i.renderBufferDirect(_,null,z,Z,y,ie),y.onAfterShadow(i,y,R,_,z,Z,ie)}}}else if(I.visible){const H=N(y,I,T,C);y.onBeforeShadow(i,y,R,_,z,H,null),i.renderBufferDirect(_,null,z,H,y,null),y.onAfterShadow(i,y,R,_,z,H,null)}}const F=y.children;for(let z=0,I=F.length;z<I;z++)M(F[z],R,_,T,C)}function E(y){y.target.removeEventListener("dispose",E);for(const _ in c){const T=c[_],C=y.target.uuid;C in T&&(T[C].dispose(),delete T[C])}}}function E0(i,e){function t(){let P=!1;const se=new ht;let J=null;const de=new ht(0,0,0,0);return{setMask:function(he){J!==he&&!P&&(i.colorMask(he,he,he,he),J=he)},setLocked:function(he){P=he},setClear:function(he,ne,Re,Ee,rt){rt===!0&&(he*=Ee,ne*=Ee,Re*=Ee),se.set(he,ne,Re,Ee),de.equals(se)===!1&&(i.clearColor(he,ne,Re,Ee),de.copy(se))},reset:function(){P=!1,J=null,de.set(-1,0,0,0)}}}function n(){let P=!1,se=!1,J=null,de=null,he=null;return{setReversed:function(ne){if(se!==ne){const Re=e.get("EXT_clip_control");ne?Re.clipControlEXT(Re.LOWER_LEFT_EXT,Re.ZERO_TO_ONE_EXT):Re.clipControlEXT(Re.LOWER_LEFT_EXT,Re.NEGATIVE_ONE_TO_ONE_EXT),se=ne;const Ee=he;he=null,this.setClear(Ee)}},getReversed:function(){return se},setTest:function(ne){ne?te(i.DEPTH_TEST):me(i.DEPTH_TEST)},setMask:function(ne){J!==ne&&!P&&(i.depthMask(ne),J=ne)},setFunc:function(ne){if(se&&(ne=Od[ne]),de!==ne){switch(ne){case Xa:i.depthFunc(i.NEVER);break;case ja:i.depthFunc(i.ALWAYS);break;case Ya:i.depthFunc(i.LESS);break;case Qi:i.depthFunc(i.LEQUAL);break;case qa:i.depthFunc(i.EQUAL);break;case $a:i.depthFunc(i.GEQUAL);break;case Ka:i.depthFunc(i.GREATER);break;case Za:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}de=ne}},setLocked:function(ne){P=ne},setClear:function(ne){he!==ne&&(he=ne,se&&(ne=1-ne),i.clearDepth(ne))},reset:function(){P=!1,J=null,de=null,he=null,se=!1}}}function s(){let P=!1,se=null,J=null,de=null,he=null,ne=null,Re=null,Ee=null,rt=null;return{setTest:function($e){P||($e?te(i.STENCIL_TEST):me(i.STENCIL_TEST))},setMask:function($e){se!==$e&&!P&&(i.stencilMask($e),se=$e)},setFunc:function($e,Ht,qt){(J!==$e||de!==Ht||he!==qt)&&(i.stencilFunc($e,Ht,qt),J=$e,de=Ht,he=qt)},setOp:function($e,Ht,qt){(ne!==$e||Re!==Ht||Ee!==qt)&&(i.stencilOp($e,Ht,qt),ne=$e,Re=Ht,Ee=qt)},setLocked:function($e){P=$e},setClear:function($e){rt!==$e&&(i.clearStencil($e),rt=$e)},reset:function(){P=!1,se=null,J=null,de=null,he=null,ne=null,Re=null,Ee=null,rt=null}}}const a=new t,r=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},p={},u={},m=new WeakMap,v=[],b=null,x=!1,f=null,w=null,N=null,M=null,E=null,y=null,R=null,_=new ze(0,0,0),T=0,C=!1,L=null,F=null,z=null,I=null,H=null;const j=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,ie=0;const W=i.getParameter(i.VERSION);W.indexOf("WebGL")!==-1?(ie=parseFloat(/^WebGL (\d)/.exec(W)[1]),Y=ie>=1):W.indexOf("OpenGL ES")!==-1&&(ie=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),Y=ie>=2);let Z=null,ee={};const be=i.getParameter(i.SCISSOR_BOX),Te=i.getParameter(i.VIEWPORT),et=new ht().fromArray(be),Ge=new ht().fromArray(Te);function qe(P,se,J,de){const he=new Uint8Array(4),ne=i.createTexture();i.bindTexture(P,ne),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Re=0;Re<J;Re++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(se,0,i.RGBA,1,1,de,0,i.RGBA,i.UNSIGNED_BYTE,he):i.texImage2D(se+Re,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,he);return ne}const K={};K[i.TEXTURE_2D]=qe(i.TEXTURE_2D,i.TEXTURE_2D,1),K[i.TEXTURE_CUBE_MAP]=qe(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[i.TEXTURE_2D_ARRAY]=qe(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),K[i.TEXTURE_3D]=qe(i.TEXTURE_3D,i.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),te(i.DEPTH_TEST),r.setFunc(Qi),ke(!1),tt(_o),te(i.CULL_FACE),Ye(Nn);function te(P){h[P]!==!0&&(i.enable(P),h[P]=!0)}function me(P){h[P]!==!1&&(i.disable(P),h[P]=!1)}function Ne(P,se){return u[P]!==se?(i.bindFramebuffer(P,se),u[P]=se,P===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=se),P===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=se),!0):!1}function xe(P,se){let J=v,de=!1;if(P){J=m.get(se),J===void 0&&(J=[],m.set(se,J));const he=P.textures;if(J.length!==he.length||J[0]!==i.COLOR_ATTACHMENT0){for(let ne=0,Re=he.length;ne<Re;ne++)J[ne]=i.COLOR_ATTACHMENT0+ne;J.length=he.length,de=!0}}else J[0]!==i.BACK&&(J[0]=i.BACK,de=!0);de&&i.drawBuffers(J)}function Ue(P){return b!==P?(i.useProgram(P),b=P,!0):!1}const pt={[bi]:i.FUNC_ADD,[sd]:i.FUNC_SUBTRACT,[ad]:i.FUNC_REVERSE_SUBTRACT};pt[rd]=i.MIN,pt[od]=i.MAX;const Fe={[ld]:i.ZERO,[cd]:i.ONE,[dd]:i.SRC_COLOR,[Rl]:i.SRC_ALPHA,[gd]:i.SRC_ALPHA_SATURATE,[pd]:i.DST_COLOR,[hd]:i.DST_ALPHA,[ud]:i.ONE_MINUS_SRC_COLOR,[Cl]:i.ONE_MINUS_SRC_ALPHA,[md]:i.ONE_MINUS_DST_COLOR,[fd]:i.ONE_MINUS_DST_ALPHA,[xd]:i.CONSTANT_COLOR,[_d]:i.ONE_MINUS_CONSTANT_COLOR,[vd]:i.CONSTANT_ALPHA,[Sd]:i.ONE_MINUS_CONSTANT_ALPHA};function Ye(P,se,J,de,he,ne,Re,Ee,rt,$e){if(P===Nn){x===!0&&(me(i.BLEND),x=!1);return}if(x===!1&&(te(i.BLEND),x=!0),P!==id){if(P!==f||$e!==C){if((w!==bi||E!==bi)&&(i.blendEquation(i.FUNC_ADD),w=bi,E=bi),$e)switch(P){case Yi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ji:i.blendFunc(i.ONE,i.ONE);break;case vo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case So:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ze("WebGLState: Invalid blending: ",P);break}else switch(P){case Yi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ji:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case vo:Ze("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case So:Ze("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ze("WebGLState: Invalid blending: ",P);break}N=null,M=null,y=null,R=null,_.set(0,0,0),T=0,f=P,C=$e}return}he=he||se,ne=ne||J,Re=Re||de,(se!==w||he!==E)&&(i.blendEquationSeparate(pt[se],pt[he]),w=se,E=he),(J!==N||de!==M||ne!==y||Re!==R)&&(i.blendFuncSeparate(Fe[J],Fe[de],Fe[ne],Fe[Re]),N=J,M=de,y=ne,R=Re),(Ee.equals(_)===!1||rt!==T)&&(i.blendColor(Ee.r,Ee.g,Ee.b,rt),_.copy(Ee),T=rt),f=P,C=!1}function at(P,se){P.side===gn?me(i.CULL_FACE):te(i.CULL_FACE);let J=P.side===zt;se&&(J=!J),ke(J),P.blending===Yi&&P.transparent===!1?Ye(Nn):Ye(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),r.setFunc(P.depthFunc),r.setTest(P.depthTest),r.setMask(P.depthWrite),a.setMask(P.colorWrite);const de=P.stencilWrite;o.setTest(de),de&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),Ct(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?te(i.SAMPLE_ALPHA_TO_COVERAGE):me(i.SAMPLE_ALPHA_TO_COVERAGE)}function ke(P){L!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),L=P)}function tt(P){P!==ed?(te(i.CULL_FACE),P!==F&&(P===_o?i.cullFace(i.BACK):P===td?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):me(i.CULL_FACE),F=P}function xt(P){P!==z&&(Y&&i.lineWidth(P),z=P)}function Ct(P,se,J){P?(te(i.POLYGON_OFFSET_FILL),(I!==se||H!==J)&&(I=se,H=J,r.getReversed()&&(se=-se),i.polygonOffset(se,J))):me(i.POLYGON_OFFSET_FILL)}function dt(P){P?te(i.SCISSOR_TEST):me(i.SCISSOR_TEST)}function mt(P){P===void 0&&(P=i.TEXTURE0+j-1),Z!==P&&(i.activeTexture(P),Z=P)}function U(P,se,J){J===void 0&&(Z===null?J=i.TEXTURE0+j-1:J=Z);let de=ee[J];de===void 0&&(de={type:void 0,texture:void 0},ee[J]=de),(de.type!==P||de.texture!==se)&&(Z!==J&&(i.activeTexture(J),Z=J),i.bindTexture(P,se||K[P]),de.type=P,de.texture=se)}function bt(){const P=ee[Z];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function Ve(){try{i.compressedTexImage2D(...arguments)}catch(P){Ze("WebGLState:",P)}}function A(){try{i.compressedTexImage3D(...arguments)}catch(P){Ze("WebGLState:",P)}}function g(){try{i.texSubImage2D(...arguments)}catch(P){Ze("WebGLState:",P)}}function O(){try{i.texSubImage3D(...arguments)}catch(P){Ze("WebGLState:",P)}}function V(){try{i.compressedTexSubImage2D(...arguments)}catch(P){Ze("WebGLState:",P)}}function q(){try{i.compressedTexSubImage3D(...arguments)}catch(P){Ze("WebGLState:",P)}}function ae(){try{i.texStorage2D(...arguments)}catch(P){Ze("WebGLState:",P)}}function oe(){try{i.texStorage3D(...arguments)}catch(P){Ze("WebGLState:",P)}}function $(){try{i.texImage2D(...arguments)}catch(P){Ze("WebGLState:",P)}}function Q(){try{i.texImage3D(...arguments)}catch(P){Ze("WebGLState:",P)}}function ce(P){return p[P]!==void 0?p[P]:i.getParameter(P)}function we(P,se){p[P]!==se&&(i.pixelStorei(P,se),p[P]=se)}function ue(P){et.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),et.copy(P))}function le(P){Ge.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),Ge.copy(P))}function Ae(P,se){let J=c.get(se);J===void 0&&(J=new WeakMap,c.set(se,J));let de=J.get(P);de===void 0&&(de=i.getUniformBlockIndex(se,P.name),J.set(P,de))}function Ce(P,se){const de=c.get(se).get(P);l.get(se)!==de&&(i.uniformBlockBinding(se,de,P.__bindingPointIndex),l.set(se,de))}function De(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),r.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},p={},Z=null,ee={},u={},m=new WeakMap,v=[],b=null,x=!1,f=null,w=null,N=null,M=null,E=null,y=null,R=null,_=new ze(0,0,0),T=0,C=!1,L=null,F=null,z=null,I=null,H=null,et.set(0,0,i.canvas.width,i.canvas.height),Ge.set(0,0,i.canvas.width,i.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:te,disable:me,bindFramebuffer:Ne,drawBuffers:xe,useProgram:Ue,setBlending:Ye,setMaterial:at,setFlipSided:ke,setCullFace:tt,setLineWidth:xt,setPolygonOffset:Ct,setScissorTest:dt,activeTexture:mt,bindTexture:U,unbindTexture:bt,compressedTexImage2D:Ve,compressedTexImage3D:A,texImage2D:$,texImage3D:Q,pixelStorei:we,getParameter:ce,updateUBOMapping:Ae,uniformBlockBinding:Ce,texStorage2D:ae,texStorage3D:oe,texSubImage2D:g,texSubImage3D:O,compressedTexSubImage2D:V,compressedTexSubImage3D:q,scissor:ue,viewport:le,reset:De}}function T0(i,e,t,n,s,a,r){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new je,h=new WeakMap,p=new Set;let u;const m=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(A,g){return v?new OffscreenCanvas(A,g):ea("canvas")}function x(A,g,O){let V=1;const q=Ve(A);if((q.width>O||q.height>O)&&(V=O/Math.max(q.width,q.height)),V<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const ae=Math.floor(V*q.width),oe=Math.floor(V*q.height);u===void 0&&(u=b(ae,oe));const $=g?b(ae,oe):u;return $.width=ae,$.height=oe,$.getContext("2d").drawImage(A,0,0,ae,oe),Ie("WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+ae+"x"+oe+")."),$}else return"data"in A&&Ie("WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),A;return A}function f(A){return A.generateMipmaps}function w(A){i.generateMipmap(A)}function N(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(A,g,O,V,q,ae=!1){if(A!==null){if(i[A]!==void 0)return i[A];Ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let oe;V&&(oe=e.get("EXT_texture_norm16"),oe||Ie("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let $=g;if(g===i.RED&&(O===i.FLOAT&&($=i.R32F),O===i.HALF_FLOAT&&($=i.R16F),O===i.UNSIGNED_BYTE&&($=i.R8),O===i.UNSIGNED_SHORT&&oe&&($=oe.R16_EXT),O===i.SHORT&&oe&&($=oe.R16_SNORM_EXT)),g===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&($=i.R8UI),O===i.UNSIGNED_SHORT&&($=i.R16UI),O===i.UNSIGNED_INT&&($=i.R32UI),O===i.BYTE&&($=i.R8I),O===i.SHORT&&($=i.R16I),O===i.INT&&($=i.R32I)),g===i.RG&&(O===i.FLOAT&&($=i.RG32F),O===i.HALF_FLOAT&&($=i.RG16F),O===i.UNSIGNED_BYTE&&($=i.RG8),O===i.UNSIGNED_SHORT&&oe&&($=oe.RG16_EXT),O===i.SHORT&&oe&&($=oe.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&($=i.RG8UI),O===i.UNSIGNED_SHORT&&($=i.RG16UI),O===i.UNSIGNED_INT&&($=i.RG32UI),O===i.BYTE&&($=i.RG8I),O===i.SHORT&&($=i.RG16I),O===i.INT&&($=i.RG32I)),g===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&($=i.RGB8UI),O===i.UNSIGNED_SHORT&&($=i.RGB16UI),O===i.UNSIGNED_INT&&($=i.RGB32UI),O===i.BYTE&&($=i.RGB8I),O===i.SHORT&&($=i.RGB16I),O===i.INT&&($=i.RGB32I)),g===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&($=i.RGBA8UI),O===i.UNSIGNED_SHORT&&($=i.RGBA16UI),O===i.UNSIGNED_INT&&($=i.RGBA32UI),O===i.BYTE&&($=i.RGBA8I),O===i.SHORT&&($=i.RGBA16I),O===i.INT&&($=i.RGBA32I)),g===i.RGB&&(O===i.UNSIGNED_SHORT&&oe&&($=oe.RGB16_EXT),O===i.SHORT&&oe&&($=oe.RGB16_SNORM_EXT),O===i.UNSIGNED_INT_5_9_9_9_REV&&($=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&($=i.R11F_G11F_B10F)),g===i.RGBA){const Q=ae?Qs:Xe.getTransfer(q);O===i.FLOAT&&($=i.RGBA32F),O===i.HALF_FLOAT&&($=i.RGBA16F),O===i.UNSIGNED_BYTE&&($=Q===st?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT&&oe&&($=oe.RGBA16_EXT),O===i.SHORT&&oe&&($=oe.RGBA16_SNORM_EXT),O===i.UNSIGNED_SHORT_4_4_4_4&&($=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&($=i.RGB5_A1)}return($===i.R16F||$===i.R32F||$===i.RG16F||$===i.RG32F||$===i.RGBA16F||$===i.RGBA32F)&&e.get("EXT_color_buffer_float"),$}function E(A,g){let O;return A?g===null||g===Sn||g===ts?O=i.DEPTH24_STENCIL8:g===xn?O=i.DEPTH32F_STENCIL8:g===es&&(O=i.DEPTH24_STENCIL8,Ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Sn||g===ts?O=i.DEPTH_COMPONENT24:g===xn?O=i.DEPTH_COMPONENT32F:g===es&&(O=i.DEPTH_COMPONENT16),O}function y(A,g){return f(A)===!0||A.isFramebufferTexture&&A.minFilter!==At&&A.minFilter!==Pt?Math.log2(Math.max(g.width,g.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?g.mipmaps.length:1}function R(A){const g=A.target;g.removeEventListener("dispose",R),T(g),g.isVideoTexture&&h.delete(g),g.isHTMLTexture&&p.delete(g)}function _(A){const g=A.target;g.removeEventListener("dispose",_),L(g)}function T(A){const g=n.get(A);if(g.__webglInit===void 0)return;const O=A.source,V=m.get(O);if(V){const q=V[g.__cacheKey];q.usedTimes--,q.usedTimes===0&&C(A),Object.keys(V).length===0&&m.delete(O)}n.remove(A)}function C(A){const g=n.get(A);i.deleteTexture(g.__webglTexture);const O=A.source,V=m.get(O);delete V[g.__cacheKey],r.memory.textures--}function L(A){const g=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let V=0;V<6;V++){if(Array.isArray(g.__webglFramebuffer[V]))for(let q=0;q<g.__webglFramebuffer[V].length;q++)i.deleteFramebuffer(g.__webglFramebuffer[V][q]);else i.deleteFramebuffer(g.__webglFramebuffer[V]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[V])}else{if(Array.isArray(g.__webglFramebuffer))for(let V=0;V<g.__webglFramebuffer.length;V++)i.deleteFramebuffer(g.__webglFramebuffer[V]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let V=0;V<g.__webglColorRenderbuffer.length;V++)g.__webglColorRenderbuffer[V]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[V]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const O=A.textures;for(let V=0,q=O.length;V<q;V++){const ae=n.get(O[V]);ae.__webglTexture&&(i.deleteTexture(ae.__webglTexture),r.memory.textures--),n.remove(O[V])}n.remove(A)}let F=0;function z(){F=0}function I(){return F}function H(A){F=A}function j(){const A=F;return A>=s.maxTextures&&Ie("WebGLTextures: Trying to use "+(A+1)+" texture units while this GPU supports only "+s.maxTextures),F+=1,A}function Y(A){const g=[];return g.push(A.wrapS),g.push(A.wrapT),g.push(A.wrapR||0),g.push(A.magFilter),g.push(A.minFilter),g.push(A.anisotropy),g.push(A.internalFormat),g.push(A.format),g.push(A.type),g.push(A.generateMipmaps),g.push(A.premultiplyAlpha),g.push(A.flipY),g.push(A.unpackAlignment),g.push(A.colorSpace),g.join()}function ie(A,g){const O=n.get(A);if(A.isVideoTexture&&U(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&O.__version!==A.version){const V=A.image;if(V===null)Ie("WebGLRenderer: Texture marked for update but no image data found.");else if(V.complete===!1)Ie("WebGLRenderer: Texture marked for update but image is incomplete");else{me(O,A,g);return}}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+g)}function W(A,g){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){me(O,A,g);return}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+g)}function Z(A,g){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){me(O,A,g);return}t.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+g)}function ee(A,g){const O=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&O.__version!==A.version){Ne(O,A,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+g)}const be={[Ja]:i.REPEAT,[Cn]:i.CLAMP_TO_EDGE,[Qa]:i.MIRRORED_REPEAT},Te={[At]:i.NEAREST,[yd]:i.NEAREST_MIPMAP_NEAREST,[_s]:i.NEAREST_MIPMAP_LINEAR,[Pt]:i.LINEAR,[pa]:i.LINEAR_MIPMAP_NEAREST,[Zn]:i.LINEAR_MIPMAP_LINEAR},et={[Ad]:i.NEVER,[Dd]:i.ALWAYS,[Rd]:i.LESS,[Hr]:i.LEQUAL,[Cd]:i.EQUAL,[Vr]:i.GEQUAL,[Nd]:i.GREATER,[Id]:i.NOTEQUAL};function Ge(A,g){if(g.type===xn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Pt||g.magFilter===pa||g.magFilter===_s||g.magFilter===Zn||g.minFilter===Pt||g.minFilter===pa||g.minFilter===_s||g.minFilter===Zn)&&Ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,be[g.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,be[g.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,be[g.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,Te[g.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,Te[g.minFilter]),g.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,et[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===At||g.minFilter!==_s&&g.minFilter!==Zn||g.type===xn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");i.texParameterf(A,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function qe(A,g){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,g.addEventListener("dispose",R));const V=g.source;let q=m.get(V);q===void 0&&(q={},m.set(V,q));const ae=Y(g);if(ae!==A.__cacheKey){q[ae]===void 0&&(q[ae]={texture:i.createTexture(),usedTimes:0},r.memory.textures++,O=!0),q[ae].usedTimes++;const oe=q[A.__cacheKey];oe!==void 0&&(q[A.__cacheKey].usedTimes--,oe.usedTimes===0&&C(g)),A.__cacheKey=ae,A.__webglTexture=q[ae].texture}return O}function K(A,g,O){return Math.floor(Math.floor(A/O)/g)}function te(A,g,O,V){const ae=A.updateRanges;if(ae.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,O,V,g.data);else{ae.sort((we,ue)=>we.start-ue.start);let oe=0;for(let we=1;we<ae.length;we++){const ue=ae[oe],le=ae[we],Ae=ue.start+ue.count,Ce=K(le.start,g.width,4),De=K(ue.start,g.width,4);le.start<=Ae+1&&Ce===De&&K(le.start+le.count-1,g.width,4)===Ce?ue.count=Math.max(ue.count,le.start+le.count-ue.start):(++oe,ae[oe]=le)}ae.length=oe+1;const $=t.getParameter(i.UNPACK_ROW_LENGTH),Q=t.getParameter(i.UNPACK_SKIP_PIXELS),ce=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let we=0,ue=ae.length;we<ue;we++){const le=ae[we],Ae=Math.floor(le.start/4),Ce=Math.ceil(le.count/4),De=Ae%g.width,P=Math.floor(Ae/g.width),se=Ce,J=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,De),t.pixelStorei(i.UNPACK_SKIP_ROWS,P),t.texSubImage2D(i.TEXTURE_2D,0,De,P,se,J,O,V,g.data)}A.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,$),t.pixelStorei(i.UNPACK_SKIP_PIXELS,Q),t.pixelStorei(i.UNPACK_SKIP_ROWS,ce)}}function me(A,g,O){let V=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(V=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(V=i.TEXTURE_3D);const q=qe(A,g),ae=g.source;t.bindTexture(V,A.__webglTexture,i.TEXTURE0+O);const oe=n.get(ae);if(ae.version!==oe.__version||q===!0){if(t.activeTexture(i.TEXTURE0+O),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const J=Xe.getPrimaries(Xe.workingColorSpace),de=g.colorSpace===Gn?null:Xe.getPrimaries(g.colorSpace),he=g.colorSpace===Gn||J===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,he)}t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let Q=x(g.image,!1,s.maxTextureSize);Q=bt(g,Q);const ce=a.convert(g.format,g.colorSpace),we=a.convert(g.type);let ue=M(g.internalFormat,ce,we,g.normalized,g.colorSpace,g.isVideoTexture);Ge(V,g);let le;const Ae=g.mipmaps,Ce=g.isVideoTexture!==!0,De=oe.__version===void 0||q===!0,P=ae.dataReady,se=y(g,Q);if(g.isDepthTexture)ue=E(g.format===Jn,g.type),De&&(Ce?t.texStorage2D(i.TEXTURE_2D,1,ue,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,ue,Q.width,Q.height,0,ce,we,null));else if(g.isDataTexture)if(Ae.length>0){Ce&&De&&t.texStorage2D(i.TEXTURE_2D,se,ue,Ae[0].width,Ae[0].height);for(let J=0,de=Ae.length;J<de;J++)le=Ae[J],Ce?P&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,le.width,le.height,ce,we,le.data):t.texImage2D(i.TEXTURE_2D,J,ue,le.width,le.height,0,ce,we,le.data);g.generateMipmaps=!1}else Ce?(De&&t.texStorage2D(i.TEXTURE_2D,se,ue,Q.width,Q.height),P&&te(g,Q,ce,we)):t.texImage2D(i.TEXTURE_2D,0,ue,Q.width,Q.height,0,ce,we,Q.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ce&&De&&t.texStorage3D(i.TEXTURE_2D_ARRAY,se,ue,Ae[0].width,Ae[0].height,Q.depth);for(let J=0,de=Ae.length;J<de;J++)if(le=Ae[J],g.format!==rn)if(ce!==null)if(Ce){if(P)if(g.layerUpdates.size>0){const he=qo(le.width,le.height,g.format,g.type);for(const ne of g.layerUpdates){const Re=le.data.subarray(ne*he/le.data.BYTES_PER_ELEMENT,(ne+1)*he/le.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,ne,le.width,le.height,1,ce,Re)}}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,le.width,le.height,Q.depth,ce,le.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,ue,le.width,le.height,Q.depth,0,le.data,0,0);else Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ce?P&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,le.width,le.height,Q.depth,ce,we,le.data):t.texImage3D(i.TEXTURE_2D_ARRAY,J,ue,le.width,le.height,Q.depth,0,ce,we,le.data);g.layerUpdates.size>0&&g.clearLayerUpdates()}else{Ce&&De&&t.texStorage2D(i.TEXTURE_2D,se,ue,Ae[0].width,Ae[0].height);for(let J=0,de=Ae.length;J<de;J++)le=Ae[J],g.format!==rn?ce!==null?Ce?P&&t.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,le.width,le.height,ce,le.data):t.compressedTexImage2D(i.TEXTURE_2D,J,ue,le.width,le.height,0,le.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ce?P&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,le.width,le.height,ce,we,le.data):t.texImage2D(i.TEXTURE_2D,J,ue,le.width,le.height,0,ce,we,le.data)}else if(g.isDataArrayTexture)if(Ce){if(De&&t.texStorage3D(i.TEXTURE_2D_ARRAY,se,ue,Q.width,Q.height,Q.depth),P)if(g.layerUpdates.size>0){const J=qo(Q.width,Q.height,g.format,g.type);for(const de of g.layerUpdates){const he=Q.data.subarray(de*J/Q.data.BYTES_PER_ELEMENT,(de+1)*J/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,de,Q.width,Q.height,1,ce,we,he)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ce,we,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ue,Q.width,Q.height,Q.depth,0,ce,we,Q.data);else if(g.isData3DTexture)Ce?(De&&t.texStorage3D(i.TEXTURE_3D,se,ue,Q.width,Q.height,Q.depth),P&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ce,we,Q.data)):t.texImage3D(i.TEXTURE_3D,0,ue,Q.width,Q.height,Q.depth,0,ce,we,Q.data);else if(g.isFramebufferTexture){if(De)if(Ce)t.texStorage2D(i.TEXTURE_2D,se,ue,Q.width,Q.height);else{let J=Q.width,de=Q.height;for(let he=0;he<se;he++)t.texImage2D(i.TEXTURE_2D,he,ue,J,de,0,ce,we,null),J>>=1,de>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){const J=i.canvas;if(J.hasAttribute("layoutsubtree")||J.setAttribute("layoutsubtree","true"),Q.parentNode!==J){J.appendChild(Q),p.add(g),J.onpaint=de=>{const he=de.changedElements;for(const ne of p)he.includes(ne.image)&&(ne.needsUpdate=!0)},J.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,Q);else{const he=i.RGBA,ne=i.RGBA,Re=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,he,ne,Re,Q)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ae.length>0){if(Ce&&De){const J=Ve(Ae[0]);t.texStorage2D(i.TEXTURE_2D,se,ue,J.width,J.height)}for(let J=0,de=Ae.length;J<de;J++)le=Ae[J],Ce?P&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ce,we,le):t.texImage2D(i.TEXTURE_2D,J,ue,ce,we,le);g.generateMipmaps=!1}else if(Ce){if(De){const J=Ve(Q);t.texStorage2D(i.TEXTURE_2D,se,ue,J.width,J.height)}P&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ce,we,Q)}else t.texImage2D(i.TEXTURE_2D,0,ue,ce,we,Q);f(g)&&w(V),oe.__version=ae.version,g.onUpdate&&g.onUpdate(g)}A.__version=g.version}function Ne(A,g,O){if(g.image.length!==6)return;const V=qe(A,g),q=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+O);const ae=n.get(q);if(q.version!==ae.__version||V===!0){t.activeTexture(i.TEXTURE0+O);const oe=Xe.getPrimaries(Xe.workingColorSpace),$=g.colorSpace===Gn?null:Xe.getPrimaries(g.colorSpace),Q=g.colorSpace===Gn||oe===$?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);const ce=g.isCompressedTexture||g.image[0].isCompressedTexture,we=g.image[0]&&g.image[0].isDataTexture,ue=[];for(let ne=0;ne<6;ne++)!ce&&!we?ue[ne]=x(g.image[ne],!0,s.maxCubemapSize):ue[ne]=we?g.image[ne].image:g.image[ne],ue[ne]=bt(g,ue[ne]);const le=ue[0],Ae=a.convert(g.format,g.colorSpace),Ce=a.convert(g.type),De=M(g.internalFormat,Ae,Ce,g.normalized,g.colorSpace),P=g.isVideoTexture!==!0,se=ae.__version===void 0||V===!0,J=q.dataReady;let de=y(g,le);Ge(i.TEXTURE_CUBE_MAP,g);let he;if(ce){P&&se&&t.texStorage2D(i.TEXTURE_CUBE_MAP,de,De,le.width,le.height);for(let ne=0;ne<6;ne++){he=ue[ne].mipmaps;for(let Re=0;Re<he.length;Re++){const Ee=he[Re];g.format!==rn?Ae!==null?P?J&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Re,0,0,Ee.width,Ee.height,Ae,Ee.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Re,De,Ee.width,Ee.height,0,Ee.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Re,0,0,Ee.width,Ee.height,Ae,Ce,Ee.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Re,De,Ee.width,Ee.height,0,Ae,Ce,Ee.data)}}}else{if(he=g.mipmaps,P&&se){he.length>0&&de++;const ne=Ve(ue[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,de,De,ne.width,ne.height)}for(let ne=0;ne<6;ne++)if(we){P?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,ue[ne].width,ue[ne].height,Ae,Ce,ue[ne].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,De,ue[ne].width,ue[ne].height,0,Ae,Ce,ue[ne].data);for(let Re=0;Re<he.length;Re++){const rt=he[Re].image[ne].image;P?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Re+1,0,0,rt.width,rt.height,Ae,Ce,rt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Re+1,De,rt.width,rt.height,0,Ae,Ce,rt.data)}}else{P?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,Ae,Ce,ue[ne]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,De,Ae,Ce,ue[ne]);for(let Re=0;Re<he.length;Re++){const Ee=he[Re];P?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Re+1,0,0,Ae,Ce,Ee.image[ne]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Re+1,De,Ae,Ce,Ee.image[ne])}}}f(g)&&w(i.TEXTURE_CUBE_MAP),ae.__version=q.version,g.onUpdate&&g.onUpdate(g)}A.__version=g.version}function xe(A,g,O,V,q,ae){const oe=a.convert(O.format,O.colorSpace),$=a.convert(O.type),Q=M(O.internalFormat,oe,$,O.normalized,O.colorSpace),ce=n.get(g),we=n.get(O);if(we.__renderTarget=g,!ce.__hasExternalTextures){const ue=Math.max(1,g.width>>ae),le=Math.max(1,g.height>>ae);q===i.TEXTURE_3D||q===i.TEXTURE_2D_ARRAY?t.texImage3D(q,ae,Q,ue,le,g.depth,0,oe,$,null):t.texImage2D(q,ae,Q,ue,le,0,oe,$,null)}t.bindFramebuffer(i.FRAMEBUFFER,A),mt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,V,q,we.__webglTexture,0,dt(g)):(q===i.TEXTURE_2D||q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,V,q,we.__webglTexture,ae),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ue(A,g,O){if(i.bindRenderbuffer(i.RENDERBUFFER,A),g.depthBuffer){const V=g.depthTexture,q=V&&V.isDepthTexture?V.type:null,ae=E(g.stencilBuffer,q),oe=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;mt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,dt(g),ae,g.width,g.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,dt(g),ae,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ae,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,oe,i.RENDERBUFFER,A)}else{const V=g.textures;for(let q=0;q<V.length;q++){const ae=V[q],oe=a.convert(ae.format,ae.colorSpace),$=a.convert(ae.type),Q=M(ae.internalFormat,oe,$,ae.normalized,ae.colorSpace);mt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,dt(g),Q,g.width,g.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,dt(g),Q,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,Q,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function pt(A,g,O){const V=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,A),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const q=n.get(g.depthTexture);if(q.__renderTarget=g,(!q.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),V){if(q.__webglInit===void 0&&(q.__webglInit=!0,g.depthTexture.addEventListener("dispose",R)),q.__webglTexture===void 0){q.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),Ge(i.TEXTURE_CUBE_MAP,g.depthTexture);const ce=a.convert(g.depthTexture.format),we=a.convert(g.depthTexture.type);let ue;g.depthTexture.format===Dn?ue=i.DEPTH_COMPONENT24:g.depthTexture.format===Jn&&(ue=i.DEPTH24_STENCIL8);for(let le=0;le<6;le++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,ue,g.width,g.height,0,ce,we,null)}}else ie(g.depthTexture,0);const ae=q.__webglTexture,oe=dt(g),$=V?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,Q=g.depthTexture.format===Jn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===Dn)mt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,$,ae,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,Q,$,ae,0);else if(g.depthTexture.format===Jn)mt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,$,ae,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,Q,$,ae,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Fe(A){const g=n.get(A),O=A.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==A.depthTexture){const V=A.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),V){const q=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,V.removeEventListener("dispose",q)};V.addEventListener("dispose",q),g.__depthDisposeCallback=q}g.__boundDepthTexture=V}if(A.depthTexture&&!g.__autoAllocateDepthBuffer)if(O)for(let V=0;V<6;V++)pt(g.__webglFramebuffer[V],A,V);else{const V=A.texture.mipmaps;V&&V.length>0?pt(g.__webglFramebuffer[0],A,0):pt(g.__webglFramebuffer,A,0)}else if(O){g.__webglDepthbuffer=[];for(let V=0;V<6;V++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[V]),g.__webglDepthbuffer[V]===void 0)g.__webglDepthbuffer[V]=i.createRenderbuffer(),Ue(g.__webglDepthbuffer[V],A,!1);else{const q=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=g.__webglDepthbuffer[V];i.bindRenderbuffer(i.RENDERBUFFER,ae),i.framebufferRenderbuffer(i.FRAMEBUFFER,q,i.RENDERBUFFER,ae)}}else{const V=A.texture.mipmaps;if(V&&V.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),Ue(g.__webglDepthbuffer,A,!1);else{const q=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ae),i.framebufferRenderbuffer(i.FRAMEBUFFER,q,i.RENDERBUFFER,ae)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ye(A,g,O){const V=n.get(A);g!==void 0&&xe(V.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Fe(A)}function at(A){const g=A.texture,O=n.get(A),V=n.get(g);A.addEventListener("dispose",_);const q=A.textures,ae=A.isWebGLCubeRenderTarget===!0,oe=q.length>1;if(oe||(V.__webglTexture===void 0&&(V.__webglTexture=i.createTexture()),V.__version=g.version,r.memory.textures++),ae){O.__webglFramebuffer=[];for(let $=0;$<6;$++)if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer[$]=[];for(let Q=0;Q<g.mipmaps.length;Q++)O.__webglFramebuffer[$][Q]=i.createFramebuffer()}else O.__webglFramebuffer[$]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){O.__webglFramebuffer=[];for(let $=0;$<g.mipmaps.length;$++)O.__webglFramebuffer[$]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(oe)for(let $=0,Q=q.length;$<Q;$++){const ce=n.get(q[$]);ce.__webglTexture===void 0&&(ce.__webglTexture=i.createTexture(),r.memory.textures++)}if(A.samples>0&&mt(A)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let $=0;$<q.length;$++){const Q=q[$];O.__webglColorRenderbuffer[$]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[$]);const ce=a.convert(Q.format,Q.colorSpace),we=a.convert(Q.type),ue=M(Q.internalFormat,ce,we,Q.normalized,Q.colorSpace,A.isXRRenderTarget===!0),le=dt(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,le,ue,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+$,i.RENDERBUFFER,O.__webglColorRenderbuffer[$])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),Ue(O.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ae){t.bindTexture(i.TEXTURE_CUBE_MAP,V.__webglTexture),Ge(i.TEXTURE_CUBE_MAP,g);for(let $=0;$<6;$++)if(g.mipmaps&&g.mipmaps.length>0)for(let Q=0;Q<g.mipmaps.length;Q++)xe(O.__webglFramebuffer[$][Q],A,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Q);else xe(O.__webglFramebuffer[$],A,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0);f(g)&&w(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){for(let $=0,Q=q.length;$<Q;$++){const ce=q[$],we=n.get(ce);let ue=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ue=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ue,we.__webglTexture),Ge(ue,ce),xe(O.__webglFramebuffer,A,ce,i.COLOR_ATTACHMENT0+$,ue,0),f(ce)&&w(ue)}t.unbindTexture()}else{let $=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&($=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture($,V.__webglTexture),Ge($,g),g.mipmaps&&g.mipmaps.length>0)for(let Q=0;Q<g.mipmaps.length;Q++)xe(O.__webglFramebuffer[Q],A,g,i.COLOR_ATTACHMENT0,$,Q);else xe(O.__webglFramebuffer,A,g,i.COLOR_ATTACHMENT0,$,0);f(g)&&w($),t.unbindTexture()}A.depthBuffer&&Fe(A)}function ke(A){const g=A.textures;for(let O=0,V=g.length;O<V;O++){const q=g[O];if(f(q)){const ae=N(A),oe=n.get(q).__webglTexture;t.bindTexture(ae,oe),w(ae),t.unbindTexture()}}}const tt=[],xt=[];function Ct(A){if(A.samples>0){if(mt(A)===!1){const g=A.textures,O=A.width,V=A.height;let q=i.COLOR_BUFFER_BIT;const ae=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=n.get(A),$=g.length>1;if($)for(let ce=0;ce<g.length;ce++)t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);const Q=A.texture.mipmaps;Q&&Q.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let ce=0;ce<g.length;ce++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(q|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(q|=i.STENCIL_BUFFER_BIT)),$){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,oe.__webglColorRenderbuffer[ce]);const we=n.get(g[ce]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,we,0)}i.blitFramebuffer(0,0,O,V,0,0,O,V,q,i.NEAREST),l===!0&&(tt.length=0,xt.length=0,tt.push(i.COLOR_ATTACHMENT0+ce),A.depthBuffer&&A.storeMultisampledDepthBuffer===!1&&(tt.push(ae),xt.push(ae),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,xt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,tt))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),$)for(let ce=0;ce<g.length;ce++){t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,oe.__webglColorRenderbuffer[ce]);const we=n.get(g[ce]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,we,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.storeMultisampledDepthBuffer===!1&&l){const g=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function dt(A){return Math.min(s.maxSamples,A.samples)}function mt(A){const g=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function U(A){const g=r.render.frame;h.get(A)!==g&&(h.set(A,g),A.update())}function bt(A,g){const O=A.colorSpace,V=A.format,q=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||O!==Js&&O!==Gn&&(Xe.getTransfer(O)===st?(V!==rn||q!==Yt)&&Ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ze("WebGLTextures: Unsupported texture color space:",O)),g}function Ve(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=j,this.resetTextureUnits=z,this.getTextureUnits=I,this.setTextureUnits=H,this.setTexture2D=ie,this.setTexture2DArray=W,this.setTexture3D=Z,this.setTextureCube=ee,this.rebindTextures=Ye,this.setupRenderTarget=at,this.updateRenderTargetMipmap=ke,this.updateMultisampleRenderTarget=Ct,this.setupDepthRenderbuffer=Fe,this.setupFrameBufferTexture=xe,this.useMultisampledRTT=mt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function w0(i,e){function t(n,s=Gn){let a;const r=Xe.getTransfer(s);if(n===Yt)return i.UNSIGNED_BYTE;if(n===Or)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Br)return i.UNSIGNED_SHORT_5_5_5_1;if(n===zl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Gl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Bl)return i.BYTE;if(n===kl)return i.SHORT;if(n===es)return i.UNSIGNED_SHORT;if(n===Fr)return i.INT;if(n===Sn)return i.UNSIGNED_INT;if(n===xn)return i.FLOAT;if(n===Mn)return i.HALF_FLOAT;if(n===Hl)return i.ALPHA;if(n===Vl)return i.RGB;if(n===rn)return i.RGBA;if(n===Dn)return i.DEPTH_COMPONENT;if(n===Jn)return i.DEPTH_STENCIL;if(n===Wl)return i.RED;if(n===kr)return i.RED_INTEGER;if(n===ii)return i.RG;if(n===zr)return i.RG_INTEGER;if(n===Gr)return i.RGBA_INTEGER;if(n===Vs||n===Ws||n===Xs||n===js)if(r===st)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(n===Vs)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ws)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Xs)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===js)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(n===Vs)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ws)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Xs)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===js)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===er||n===tr||n===nr||n===ir)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(n===er)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===tr)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===nr)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ir)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===sr||n===ar||n===rr||n===or||n===lr||n===Ks||n===cr)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(n===sr||n===ar)return r===st?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(n===rr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(n===or)return a.COMPRESSED_R11_EAC;if(n===lr)return a.COMPRESSED_SIGNED_R11_EAC;if(n===Ks)return a.COMPRESSED_RG11_EAC;if(n===cr)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===dr||n===ur||n===hr||n===fr||n===pr||n===mr||n===gr||n===xr||n===_r||n===vr||n===Sr||n===Mr||n===br||n===yr)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(n===dr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ur)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===hr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===fr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===pr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===mr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===gr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===xr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===_r)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===vr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Sr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Mr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===br)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===yr)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Er||n===Tr||n===wr)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(n===Er)return r===st?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Tr)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===wr)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ar||n===Rr||n===Zs||n===Cr)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(n===Ar)return a.COMPRESSED_RED_RGTC1_EXT;if(n===Rr)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Zs)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Cr)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ts?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const A0=`
void main() {
