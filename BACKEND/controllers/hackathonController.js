    ...
    if (detectedType === 'REGISTRATION') {
      ...
      return res.status(200).json({
        ...
        stats: {
          ...
          totalNewMembers: preview.newMembersCount,
          totalUpdatedMembers: preview.updatedMembersCount,
          invalidCount: preview.invalidCount,
          newCount: preview.newTeamsCount,
          duplicateCount: preview.updatedTeamsCount,
          existingUpdateCount: preview.updatedTeamsCount,
          teamsToImportCount: preview.newTeamsCount + preview.updatedTeamsCount,
